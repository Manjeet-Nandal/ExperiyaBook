...
urlpatterns = [
    ...
    path('service_provider/broker/<str:id>/del',
         del_broker_code, name='del_broker_code'),
    path('vehicle/', vehicle_view, name='vehi'),
    path('vehicle/<str:id>/', delete_vehicle, name='del_vehicle'),
    path('vehicle/<str:id>/category', delete_vehicle_category,
         name='delete_vehicle_category'),
    path('vehicle/<str:id>/model', delete_vehicle_model,
         name='delete_vehicle_model'),
    ...
    path('slab/slab_payoutformshow/<str:id>',
         slab_payoutformshow, name="slab_payoutformshow"),
    path('slab/slab_payoutlist/payout/<str:id>/delete',
         payout_delete, name="payout_delete"),
    path('slab/slab_payoutlist/payout/<str:id>/copy',
         payout_copy, name="payout_copy"),
    path('slab/slab_payoutlist/payout/<str:id>/edit',
