...
def policy_entry_single_filter(data, f_data):
    try:
        print('policy_entry_single_filter method') 
        print('data is ', data)
            ...
            if key.__contains__('#vc'):               
                ...
                if len(qs_list) > 0:
                    ...
                    for m in items_coll:
                        ...
                        for obj in f_data:                           
                            if itm == obj['vehicle_catagory']:    
                                qs_list.append(Policy.objects.filter(policyid=obj['policyid']).values())
   
    if str(data).__contains__('#ft'):
        print('has #ft')
        for k in data:
            # Getting name
            coll = (str(k).split(','))
            ...
            if key.__contains__('#ft'):               
                ...
                if len(qs_list) > 0:
                    ...
                    for m in items_coll:
                        ...
                        for obj in f_data:                           
                            if itm == obj['vehicle_fuel_type']:    
                                qs_list.append(Policy.objects.filter(policyid=obj['policyid']).values())
   
    if str(data).__contains__('#cc'):
        print('has #cc')
        for k in data:
            # Getting name
            coll = (str(k).split(','))
            ...
            if key.__contains__('#cc'):               
                ...
                if len(qs_list) > 0:
                    ...
                    for m in items_coll:
                        ...
                        for obj in f_data:                           
                            if itm == obj['cubic_capacity']:    
                                qs_list.append(Policy.objects.filter(policyid=obj['policyid']).values())
       
    if str(data).__contains__('#sc'):
        print('has #sc')
        for k in data:
            # Getting name
            coll = (str(k).split(','))
            ...
            if key.__contains__('#sc'):               
                ...
                if len(qs_list) > 0:
                    ...
                    for m in items_coll:
                        ...
                        for obj in f_data:                           
                            if itm == obj['seating_capacity']:    
                                qs_list.append(Policy.objects.filter(policyid=obj['policyid']).values())
    
    if str(data).__contains__('#ct'):
        print('has #ct')
        for k in data:
            # Getting name
            coll = (str(k).split(','))
            ...
            if key.__contains__('#ct'):               
                ...
                if len(qs_list) > 0:
                    ...
                    for m in items_coll:
                        ...
                        for obj in f_data:                           
                            if itm == obj['coverage_type']:    
                                qs_list.append(Policy.objects.filter(policyid=obj['policyid']).values())
   
    if str(data).__contains__('#gvw'):
        print('has #gvw')
        for k in data:
            # Getting name
            coll = (str(k).split(','))
            ...
            if key.__contains__('#pt'):               
                ...
                if len(qs_list) > 0:
                    ...
                    for m in items_coll:
                        ...
                        for obj in f_data:                           
                            if itm == obj['policy_type']:    
                                qs_list.append(Policy.objects.filter(policyid=obj['policyid']).values())
    
    if str(data).__contains__('#addon'):
        print('has #addon')
        for k in data:
            # Getting name
            coll = (str(k).split(','))
